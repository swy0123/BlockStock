...
function MessageBoxList({ name, onButtonClick, message }) {
  ...
  const deleteMessages = async () => {
    ...
    console.log(res);
    if (res === 200) {
      swal("쪽지 삭제", "쪽지가 삭제되었습니다.", "success")
      console.log("목록 다시 불러오기");
      messageListApi(name);
    }
  };
                  ...
                  <MessageItem>
                    <Box>
                      ...
                      {name === "send" ? (
                        <>
                          <MessageItemImg
                            src={`https://j9b210.p.ssafy.io:8443/api/member/profile/${item.receiverId}`}
                          />
                          <MessageItemNickName>
                        ...
                        <>
                          <MessageItemImg
                            src={`https://j9b210.p.ssafy.io:8443/api/member/profile/${item.senderId}`}
                          />
                          <MessageItemNickName>
                            {item.senderNickname}
                          </MessageItemNickName>
