...
@router.get("/trade/{contestId}/{memberId}")
def get_trade_contest(request: Request, contestId: int, memberId: int):
    return contest_service.get_trade_contest(contest_id=contestId, member_id=memberId)